...
```bash
INIT=$(node "/home/xun/project/diangong/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/xun/project/diangong/.codex/get-shit-done/templates/spec.md.
