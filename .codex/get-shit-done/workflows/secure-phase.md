...
```
Agent(
  prompt="Read /home/xun/project/diangong/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/xun/project/diangong/.codex/get-shit-done/templates/SECURITY.md`
