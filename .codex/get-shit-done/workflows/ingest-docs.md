...
```bash
INIT=$(node "/home/xun/project/diangong/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/xun/project/diangong/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
