...
INSTALL_JS_GLOBAL="/home/xun/project/diangong/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/xun/project/diangong/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
