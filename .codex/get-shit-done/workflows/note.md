...
- **Global scope**: `/home/xun/project/diangong/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/xun/project/diangong/.codex/notes/`)
...
2. Glob `/home/xun/project/diangong/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/xun/project/diangong/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/xun/project/diangong/.codex/notes/` — works in any directory
